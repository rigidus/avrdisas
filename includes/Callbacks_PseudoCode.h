...
void st1_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void st2_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void st3_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void sty1_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void sty2_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void sty3_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void sty4_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void stz1_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void stz2_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void stz3_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void stz4_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void ld1_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void ld2_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void ld3_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void ldy1_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void ldy2_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void ldy3_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void ldy4_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void ldz1_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void ldz2_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void ldz3_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void ldz4_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void icall_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void ijmp_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void sbrc_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
void sbrs_Callback_PC(char *Bitstream, int Position, int MNemonic_Int);
